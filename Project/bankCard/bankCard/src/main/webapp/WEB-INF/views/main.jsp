...
<body>
	...
	<div class="dropdown" align="center">
	  <button class="dropbtn">사람들이 많이 찾는 카드 탑 10</button>
	  <div class="dropdown-content">
	  	<c:forEach items="${cardList}" var="list" varStatus="status">
	    	<a href="#">
			    <span style="color: red;"><c:out value="${status.count }"/>.</span>
	    		<span>${list.cardName }</span>
	    		<img src="${pageContext.request.contextPath}/card/${list.cardImage}" class="cardImage"/>
	    	</a>
	  	</c:forEach>
	  </div>
	</div>
	<div class="section">
		...
		<div class="slidewrap" style="width: 45em;">
			<ul class="slidelist">
				<li>
					<a>
