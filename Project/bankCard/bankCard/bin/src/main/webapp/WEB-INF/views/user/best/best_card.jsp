            ...
            <div class="fixedPreview_3Slfb preview_Qee0B" style="margin-top : 56px;">
                ...
                <div class="foot_2aDGD">
                    <section class="result_tFmiI">
                        ...
                        <span class="resultValue_rynW5" id="resultValueCash">10,000원</span>
                    </section>
                    <a href="javascript:bestCardSubmit()" class="next_2m58y">결과보기</a>
                </div>
            </div>
        </div>
    </DIV>
    ...
    function resultCashList(placeName, placeValue) {
        ...
        for (const [key, value] of Object.entries(resultObject)) {
            ...
            if(value != 0) {
                ...
                str_arr += '<span class="clearableValue_2Aovs value_3k1fw">' + (value).toLocaleString();
